...
while (close==0):
    ...
    match opcion :
        ...
        case 6: 
            ...
            nuevoYear = verificarInputInt("Ingrese el año de los Investigadores a cambiar el area: ")
            nuevoArea = verificarInputStr("Ingrese la nueva area de los Investigadores:  ")
            asignacionMasiva(nuevoYear, nuevoArea, ListaInv)
